export type RackWidgetPosition = { x:number; y:number; width?:number; height?:number; control?:"selector"; centered?:boolean; widget?:string };
export type ParamSpec = { id: number; name: string; min: number; max: number; default: number; snap?: boolean; button?: boolean; hidden?:boolean; position?:RackWidgetPosition };
...
export type WebPluginModule = {
  ...
  runtime?: {
    ...
    capture?: { format: "wav"; channels: "input-dependent" };
    asset?: { type: "audio" | "image"; maxSamples: number; maxSeconds: number; channels: 1 | 2 | 4; slots?: number; url?: true };
