// Automatically isolated from the original Rack DSP module for Venom/VCAMix4.
// Source: https://github.com/DaveBenham/VenomModules (src/VCAMix4.cpp; registered in src/VCAMix4.cpp)
...
RACK_WEB_EXPORTS(Venom::VCAMix4)
